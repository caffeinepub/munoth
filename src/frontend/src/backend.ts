...
import type { ExternalBlob as _ExternalBlob, MediaType as _MediaType, Memory as _Memory, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createAlbum(arg0: string, arg1: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async createMemory(arg0: ExternalBlob, arg1: MediaType, arg2: string, arg3: string | null): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createMemory(await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg0), to_candid_MediaType_n11(this._uploadFile, this._downloadFile, arg1), arg2, to_candid_opt_n13(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAlbumsList(): Promise<Array<Album>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAlbumsList();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFeed(): Promise<Array<Memory>> {
        if (this.processError) {
            try {
    ...
    async getMemoriesByAlbum(arg0: string): Promise<Array<Memory>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMemoriesByAlbum(arg0);
                return from_candid_vec_n17(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeComment(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeComment(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateAlbum(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateAlbum(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateMemory(arg0: string, arg1: string, arg2: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateMemory(arg0, arg1, to_candid_opt_n13(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Memory_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Memory): Promise<Memory> {
...
async function from_candid_vec_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Memory>): Promise<Array<Memory>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Memory_n18(_uploadFile, _downloadFile, x)));
}
